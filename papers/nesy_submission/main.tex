% Self-published preprint. Not submitted to NeSy 2026; the NeSy/PMLR class is
% used for formatting only. Use [anon] only for a real double-blind submission.
\documentclass[preprint]{nesy2026}
...
\clearauthor{\Name{Mike H Lee} \Email{mike@oasis-x.io}\\
  \addr O-X}
